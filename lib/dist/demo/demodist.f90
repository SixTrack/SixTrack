...
program demodist
    ...
    call setparameter(1,one,one,1,0);
    call setparameter(2,zero,pia2,50,3);
    call setparameter(3,one,one,1,0);
    call setparameter(4,zero,pia2,50,3);
    call setparameter(5,one,one,1,0);
    call setparameter(6,zero,pia2,100,3);
