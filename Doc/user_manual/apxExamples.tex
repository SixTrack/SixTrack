...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=16cm,height=18cm]{figures/expout1}
\end{center}
\end{figure}
...
\begin{center}
  \mbox{\includegraphics[width=16cm,height=6.5cm]{figures/expout2}}
\end{center}
\end{figure}
...
\begin{figure}[H]\vspace{-5mm}
\begin{center}
  \mbox{\includegraphics[width=16cm,height=13cm]{figures/expout3}}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
  \mbox{\includegraphics[width=16cm,height=21cm]{figures/expout4}}
\end{center}
\end{figure}
