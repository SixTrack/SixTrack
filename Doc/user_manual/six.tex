...
\paragraph{Format} \emph{name type thetamax r2 r1 offset\_x offset\_y flag\_entrance flag\_exit $\sigma$}
...
The implementation of the UNIFORM and GAUSSIAN types (ideal e-lenses) has no explicit energy-dependency, except for the user defined parameter \emph{thetamax} (see \cite{sixphys}).
