...
A description of the input parameters for the different e-lens types is given in Table~\ref{ELEN}. Currently only the ideal hollow electron lens is implemented in SixTrack (type ANNULAR). 
\begin{center}
	\begin{longtable}{|p{2.25cm} | p{2.0cm} p{1.0cm} p{10.5cm}|}
		%Note: \\* (with the star) used to inhibit page breaks in the middle of groups of the same type
		...
		& \emph{flag\_exit} & - &
		enable bends at exit of e-lens.\\*
	\end{longtable}
\end{center}
