...
\end{center}
\begin{center}\em
  F. Schmidt, update by A.~Alekou, M.~Fitterer, J.F.~Wagner, S.J.~Wretborn, R.~De~Maria, S.~Kostoglou and K.~Sjobak
\end{center}
\begin{center}\large
  {\bf Abstract} \\
\end{center}
...
\begin{tabular}{|l | l l p{6cm}|}
  ...
  \hline
    ...
    & \texttt{scaling}     & --      & Scaling of probability, see Section~\ref{sec:scatter:elem} \\
    &      &       &  \\
    &      &       &  \\
  \hline
...
\todo[inline]{This module is experimental!}



\subsubsection{ELEMent} \label{sec:scatter:elem}

\subsubsection{PROfile}
%\label{sec:scatter:pro}

\subsubsection{GENerator} \label{sec:scatter:gen}

The generator block takes a name and a generator type input, followed by the parameters for the
generator type.\\
\\
\noindent\textbf{PPBEAMELASTIC}\\
\\
