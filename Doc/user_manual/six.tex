...
\subparagraph{Sign Convention} Some clarifications regarding the sign convention used
...
\begin{itemize}
 ...
 \begin{figure}[h]
 \begin{center}
 \includegraphics[width=0.8\textwidth]{BB_sep.eps}\label{fig:BB_sep}
...
\end{figure}
 ...
 \begin{figure}[h]
 \begin{center}
 \includegraphics[width=0.8\textwidth]{BB_xsing.eps}\label{fig:BB_xsing}
