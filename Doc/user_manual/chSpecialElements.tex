...
\begin{tabular}{@{}llp{0.65\linewidth}}
    ...
    \texttt{sigz,sige}     & floats  & RMS bunch length [m] and RMS energy spread \\
...
The linear ``phase trombone'' allows the introduction of a change in the tranverse phases without spoiling the linear optics of the rest of the machine, i.e. the Twiss parameters are the same at entrance and exit of the element.
...
\begin{tabular}{@{}llp{0.6\linewidth}}
    \texttt{name} & string & May contain up to 48 characters \\
