...
The current implementation (ideal e--lenses) has no explicit energy--dependency, except for the user defined parameter \texttt{theta\_r2} (see \cite{sixphys}). If \texttt{L}, \texttt{E\_k} and \texttt{I} are provided by the user, \texttt{theta\_r2} is re-calculated, taking into account the beam energy.
