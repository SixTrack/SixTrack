...
The \texttt{GNT4} block specified below must be used in addition to the standard collimation block.
...
Multiple copies of the \texttt{RETURN} flag can be used to precicely select which particles are of interest.
