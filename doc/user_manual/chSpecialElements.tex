...
for further geometrical clarifications.
...
\begin{figure}
  \centering
  \includegraphics[width=0.65\textwidth]{figures/apertureSketch.png}
  \caption{Sketch of the most general aperture currently treated by the aperture module. The purple line marks the actual aperture restriction as interpreted by the code with the given parameters.}
