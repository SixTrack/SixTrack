...
\item Note that if the user specifies \texttt{theta\_r2} with DYNK, starting with the first turn where it set via DYNK it is no longer ramped with the energy; as if the elens was specified using only this parameter in \texttt{fort.3}.
