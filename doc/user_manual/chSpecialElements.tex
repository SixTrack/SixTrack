...
This flag enables the collimator specified in \texttt{name} to be treated as a crystal collimator.
...
\bigskip
All the parameters default to zero. Additional details on the physics principles of crystal collimation can be found in~\cite{crystal:1,crystal:2}.
