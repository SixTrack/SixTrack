...
The coefficients are stored in an ASCII file (see Sec.~\ref{sec:cheby_coeff_file} for the formatting).
...
\subsection{Format of the Coefficient File} \label{cheby_format_coeff_file}
