...
\begin{longtabu}{@{}llllp{7cm}}
    ...
    \texttt{zeta}   & n/a                & [mm]         & $\zeta=\sigma/r_v$      & longitudinal offset conjugate with $\delta$\\
...
The \texttt{ZIPF} block can always be present in \texttt{fort.3}, but if SixTrack was not built with the \texttt{ZLIB} option, no archive file will be produced.
