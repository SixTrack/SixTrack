...
The module accepts a single keyword, \texttt{MD5SUM}, followed by a file name, which is optionally followed by a bolean to specify if this is an ASCII file.
This can be repeated multiple times.
The ASCII flag is used on Windows to strip carriage returns from the file before hashing.
