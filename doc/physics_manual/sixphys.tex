...
\begin{align}
x'&=x'-\frac{x}{r}\cdot\theta_{\rm R_2}\cdot\frac{R_2}{r}\cdot f(r)\cdot \frac{1}{1+\delta}\label{elense:eqn:1}\\
y'&=y'-\frac{y}{r}\cdot\theta_{\rm R_2}\cdot\frac{R_2}{r}\cdot f(r)\cdot \frac{1}{1+\delta}\label{elense:eqn:2}
\end{align}
...
$(B\rho)(\delta) = (B\rho)(0)\cdot(1+\delta)$.
...
\begin{equation}
f(r)=\frac{r^2-R_1^2}{R_2^2-R_1^2}
\end{equation}
