...
if(FAILURE)
    if(AFS AND CVMFS)
        ...
        message(STATUS "CMake thinks you are on lxplus since it can see /afs/ and /cvmfs/")
        ...
        message(STATUS "source /cvmfs/sft.cern.ch/lcg/contrib/gcc/8/x86_64-slc6/setup.sh")
        message(STATUS "!")
