...
* Fixed a bug where a negative kz of 12 (cavity element) was not converted to positive value if the print flag was off. The conversion was embedded in a loop otherwise used for printing the lattice. PR #823 (V.K. Berglyd Olsen)
