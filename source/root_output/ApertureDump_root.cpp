...
extern "C" void root_DumpAperture(char* apname_in, int apname_len, char* aptype_in, int aptype_len, double s_in, double ap1_in, double ap2_in, double ap3_in, double ap4_in, double ap5_in, double ap6_in, double ap7_in, double ap8_in, double ap9_in )
{
    RootApertureDumpOutput->DumpAperture(apname_in, apname_len, aptype_in, aptype_len, s_in, ap1_in, ap2_in, ap3_in, ap4_in, ap5_in, ap6_in, ap7_in, ap8_in, ap9_in );
}
...
ApertureDumpRootOutput::ApertureDumpRootOutput()
{
    ...
    ApertureDumpTree->Branch("type",&type,"type[4]/C");
...
void ApertureDumpRootOutput::DumpAperture(char* apname_in, int apname_len, char* aptype_in, int aptype_len, double s_in, double ap1_in, double ap2_in, double ap3_in, double ap4_in, double ap5_in, double ap6_in, double ap7_in, double ap8_in, double ap9_in )
{

    std::string tmpname(apname_in);
    std::transform(tmpname.begin(), tmpname.end(), tmpname.begin(), ::toupper);
    strncpy(name,tmpname.substr(0,apname_len).c_str(),49);

    std::string tmptype(aptype_in);
    std::transform(tmptype.begin(), tmptype.end(), tmptype.begin(), ::toupper);
    strncpy(type,tmpname.substr(0,aptype_len).c_str(),4);
