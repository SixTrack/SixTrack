...
!FOX  D V DA INT FCODA NORD NVAR 2 MMUL ;
!FOX  D V DA INT FSIDA NORD NVAR 2 MMUL ; 
...
!FOX  D V DA COM PTTDA NORD NVAR ; D V DA COM ZTDA NORD NVAR ;
...
#endif
!FOX  D V RE INT COS_T ; D V RE INT SIN_T ; D V RE INT TAN_T ;
