...
if(dki(I,3) > pieni .and. abs(dki(I,1)) > pieni .and. curveff == 1) then !Horizontal curvature effect for quadrupoles
...
else if(dki(I,3) > pieni .and. abs(dki(I,2)) > pieni .and. curveff == 1) then !Vertical curvature effect for quadrupoles
!FOX  YV1J=YV1J +
