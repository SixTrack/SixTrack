...
subroutine phasad(dpp,qwc)
  ...
  real(kind=fPrec) aa,alfa,bb,benkr,beta,ci,cikve,cr,crkve,crkveuk,dphi,dpp,dppi,dpr,&
                   dyy1,dyy2,ekk,phi,phibf,puf,qu,qv,qw,qwc,qxsa,qxse,r0,r0a,t,xl,xs,zl,zs,quz,qvz
#ifdef TILT
...
subroutine resex(dpp)
  ...
  real(kind=fPrec) aa,ab1,ab2,alfa,b,b1,b2,bb,benkr,beta,btc,bts,chy,ci,cikve,cr,crkve,cxzi,cxzr,&
          ...
          phy,puf,qu,qv,qw,r0,r0a,radi,re,re1,res,rn2,sb1,sb2,sea,seb,shy,t,vdt1,vdt2,vdt3,xl,&
          xs,zl,zs,quz,qvz
#ifdef TILT
...
subroutine subre(dpp)
  ...
  real(kind=fPrec) aa,ab1,ab2,alfa,b,b1,b2,bb,benkr,beta,btc,bts,cc_r,chy,ci,cikve,clo0,clop0,cr,crkve,&
          ...
          ekk,ekko,ep,etl,gerad,gtu1,gtu2,phi,phibf,phy,puf,qu,qv,qw,qwc,r0,r0a,radi,rc,re,re1,res,&
...
!--RE=DISTANCE FROM THE RESONANCE
              ...
              res=re(np,nv)/radi
          chy(np,nv)=cos_mb((real(nn1,fPrec)*twopi*phi(1)+real(n2,fPrec)*twopi*phi(2))-res*etl) !hr06
          shy(np,nv)=sin_mb((real(nn1,fPrec)*twopi*phi(1)+real(n2,fPrec)*twopi*phi(2))-res*etl) !hr06
  710       continue
  720     continue
          do 780 np=nta,mpe
            np2=np
...
subroutine subsea(dpp)
  ...
  real(kind=fPrec) aa,ab1,ab2,alfa,b,b1,b2,bb,benkr,beta,btc,bts,chy,ci,cikve,cr,crkve,cxzi,cxzr,&
          cxzyi,cxzyr,cxzyrr,del,dphi,dpp,dppi,dpr,dt,dyy1,dyy2,e,ea,eb,ekk,ep,etl,gerad,phi,phibf,&
          phy,puf,qu,qv,qw,r0,r0a,radi,re,re1,res,rn2,sb1,sb2,sea,seb,shy,t,vdt1,vdt2,vdt3,xl,xs,zl,zs,quz,qvz
#ifdef TILT
