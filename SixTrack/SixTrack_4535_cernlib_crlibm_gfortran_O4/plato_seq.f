...
*
      ...
      IMPLICIT NONE
      COMPLEX*8 A(1),U,W,T !Single precission complex, COMPLEX*8 is the same as
...
C................................................INTERPOLATION
     ...
     .       ATAN2_RN(CF2*SIN_RN(PI/NPOINT),CF1+CF2*COS_RN(PI/NPOINT))
      ENDIF
      TUNEABT=1D+0-(ASSK-1D+0)/DFLOAT(NPOINT) !1D+0 = 1D0, i.e. double precision
C............................................................
      RETURN
C............................................................
      END
...
C.........................................BISECTION PROCEDURE
     ...
     .        *(1D0+COS_RN(STEP*(2*N-MAX1)))
            ...
            Z(N)=ZC*(EXP_RN(TMPR)*DCMPLX(COS_RN(TMPI),SIN_RN(TMPI))) !exp_rn is
          ENDDO
